  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="warusan.php">3で割る</a></li>
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="waruni.php">2で割る</a></li>
          <li><a href="warusan.php">3で割る</a></li>
          <li class="active"><a href="kaizyou.php">階乗</a></li>
        </ul>
        <form action="kaizyou.php" method="POST">
            <div class="alert alert-info" role="alert">君は階乗できるかな？？？</div>
            <span class="label label-default">NEW!</span>
            <label>数字を入力してください: <input type="text" name="target_number2" class="form-control"></label>
            <button class="btn btn-danger" type="submit" value="送信">送信</button>
        </form>

    <p>
    <?php 
        print $_POST['target_number2']; 
    ?>
    を階乗すると
<?php 
        print $_POST['target_number']; 
    ?>
    <?php  $_POST['target_number'];
        
        for($i=1;$i<=$_POST['target_number'];$i++){
          $b=$b*$i;
        }
        print $b;
        ?>
