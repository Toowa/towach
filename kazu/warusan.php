  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="kaizyou.php">階乗</a></li>
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="yonbai.php">4倍</a></li>
          <li><a href="waruni.php">2で割る</a></li>
          <li class="active"><a href="warusan.php">3で割る</a></li>
          <li><a href="kaizyou.php">階乗</a></li>
        </ul>
        <form action="warusan.php" method="POST">
            <div class="alert alert-info" role="alert">君は割り算できるかな？？？</div>
    ...
    ?>
    を3で割ると
    <?php print $_POST['target_number2']/3;
    ?>
    です。</p>
