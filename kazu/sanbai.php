...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="kaizyoun.php">階乗</a></li>
  </ul>
</div>
        </li>
      </ul>
        ...
        <li><a href="nibai.php">2倍</a></li>
        <li class="active"><a href="sanbai.php">３倍</a></li>
        <li><a href="yonbai.php">4倍</a></li>
        <li><a href="waruni.php">2で割る</a></li>
        <li><a href="warusan.php">3で割る</a></li>
        </ul>
        
        <form action="sanbai.php" method="POST">
            <div class="alert alert-info" role="alert">君は3倍にできるかな？？？</div>
            <span class="label label-default">NEW!</span>
            <label>数字を入力してください: <input type="text" name="target_number3" class="form-control"></label>
            <button class="btn btn-danger" type="submit" value="送信">送信</button>
        </form>

    <p>
    <?php 
        print $_POST['target_number3']; 
    ?>
    の3倍は 
    <?php print $_POST['target_number3']*3;
    ?>
    です。</p>
